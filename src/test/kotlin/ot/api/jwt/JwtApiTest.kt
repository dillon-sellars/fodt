...
class JwtApiTest : StringSpec({
    "should return valid jwt parts" {
        val result =
            JwtApi.decodeJwt("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..rWtd0UlPgNAMAEI5gu1SYMqmQPZCBRbgTW7dRFJAezg")
    ...
    "should throw error on jwt with 2 parts" {
        val exception = shouldThrow<JWTDecodeException> {
